...
class Locators:
	...
	condition_used_radio = (By.XPATH, "//label[text()='Б/У']/preceding-sibling::div")
	...
	dropdown_option_buttons = (By.CSS_SELECTOR, ".dropDownMenu_btn__o8ARs")
	profile_name = (By.CSS_SELECTOR, ".profileText.name")
	profile_icon = (By.CSS_SELECTOR, ".svgSmall")